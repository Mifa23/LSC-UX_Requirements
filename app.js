...
═══════════════════════════════════════════ */
const INITIAL_DATA = [
  { requirement: "Branding customization", description: "Map JNJ branding elements: logo, and tokens: colors and icons", category: "App", solutionType: "Configuration", customLevel: "", release: "Post 0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "Overall Progress metrics", description: "Module configured for high level metrics of user / against plan", category: "Feature", solutionType: "Customization", customLevel: "TBD", release: "Post 0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "My Geo Overview metrics", description: "Module configured for high level metrics of territory / against plan", category: "Feature", solutionType: "Customization", customLevel: "TBD", release: "Post 0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "Execution metrics", description: "Module configured for region specific 'execution' metrics", category: "Feature", solutionType: "Customization", customLevel: "TBD", release: "Post 0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "FSR/KAM Affiliations", description: "Module configured to show all the JnJ interactions against account and specific HCP", category: "Feature", solutionType: "Product", customLevel: "TBD", release: "Post 0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "Customizable metrics by region", description: "Module configured for region specific metrics", category: "Feature", solutionType: "Customization", customLevel: "TBD", release: "Post 0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "Image capture for samples", description: "User can 'scan' barcodes vs input data manually of samples", category: "Feature", solutionType: "Product", customLevel: "TBD", release: "Post 0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "Filters within cards at Homepage", description: "Can be solved with tabs or tags - User needs to filter table views to relevant data to task", category: "Feature", solutionType: "Customization", customLevel: "TBD", release: "R0.5", priority: "Should have", scope: "Global", comments: "" },
  { requirement: "Timestamp of last sync on page and configured module/card level", description: "Data citation, and 'last synced' can appear at page level, or module level", category: "Feature", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Must have", scope: "Global", comments: "" },
  { requirement: "Active listening during conversations", description: "During Virtual or presentation of content, tool listens (after consent is given) for keywords to suggest content in the moment", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "Replace Agentforce icon from agent button(s)", description: "Agentforce icon is replace with JnJ icon", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "Remove any imagery related to Agentforce", description: "SF Illustrations are hidden in experience", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "Rename AI agent", description: "Use JnJ or generic agent name", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Nice to have", scope: "Global", comments: "" },
  { requirement: "AI assistance/actions based on page context", description: "Agent recognizes page context and data", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Should have", scope: "Global", comments: "" },
  { requirement: "AI agent guided flows", description: "Add common user flows as tap-able prompts that then ask user the information needed to complete flow", category: "Agentforce", solutionType: "Product", customLevel: "TBD", release: "Post 0.5", priority: "Should have", scope: "Global", comments: "" },
  ...
  { requirement: "Rename navigation Account tab with HCP 360", description: "", category: "Feature", solutionType: "Product", customLevel: "TBD", release: "R0.5", priority: "Should have", scope: "Global", comments: "" },
